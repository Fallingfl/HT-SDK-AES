...
struct BP_JinStandWarnHideSword_C_Received_NotifyBegin final
{
public:
	...
	class AWeaponBase*                            CallFunc_GetCurrentWeapon_ReturnValue;             // 0x0078(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_BP_JinStandWarnHideSword_C_Received_NotifyBegin;

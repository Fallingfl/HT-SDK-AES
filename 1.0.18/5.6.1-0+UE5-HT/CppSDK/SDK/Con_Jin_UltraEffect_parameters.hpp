...
struct Con_Jin_UltraEffect_C_CanApplyGameplayEffectContent final
{
public:
	...
	bool                                          CallFunc_IsGamePaused_ReturnValue;                 // 0x004A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_Con_Jin_UltraEffect_C_CanApplyGameplayEffectContent;

...
struct GA_Jin_UltraSkill_C_ExecuteUbergraph_GA_Jin_UltraSkill final
{
public:
	...
	class AWeaponBase*                            CallFunc_GetCurrentWeapon_ReturnValue;             // 0x0088(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_GA_Jin_UltraSkill_C_ExecuteUbergraph_GA_Jin_UltraSkill;

// Function GA_Jin_UltraSkill.GA_Jin_UltraSkill_C.K2_OnEndAbility
// 0x0001 (0x0001 - 0x0000)
struct GA_Jin_UltraSkill_C_K2_OnEndAbility final
{
public:
	bool                                          bWasCancelled;                                     // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_GA_Jin_UltraSkill_C_K2_OnEndAbility;

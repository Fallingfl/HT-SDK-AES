...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0E6B5180;
	constexpr int32 AppendString      = 0x015E9780;
	constexpr int32 GNames            = 0x0E5D1000;
	constexpr int32 GWorld            = 0x0E2D5DB0;
	constexpr int32 ProcessEvent      = 0x0182CF00;

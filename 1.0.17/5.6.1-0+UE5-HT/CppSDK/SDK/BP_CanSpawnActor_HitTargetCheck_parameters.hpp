...
struct BP_CanSpawnActor_HitTargetCheck_C_BPGetCanSpawnActor final
{
public:
	...
	class AHTMonsterCharacter*                    K2Node_DynamicCast_AsHTMonster_Character;          // 0x01F0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x01F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_CanSpawnActor_HitTargetCheck_C_BPGetCanSpawnActor;

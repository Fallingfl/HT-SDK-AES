...
void PDA_FluxSimulationState::UPDA_FluxSimulationState_C::SetSimulationWorld(const struct FVector& Location, const struct FVector& Size, int32 Frame, const struct FIntPoint& Resolution_0, const struct BS_FluxRectBlend::FBS_FluxRectBlend& Blend, double DepthOffset)
{
	static class UFunction* Func = nullptr;

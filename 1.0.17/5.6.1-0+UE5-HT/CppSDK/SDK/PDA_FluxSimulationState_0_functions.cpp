...
void PDA_FluxSimulationState_0::UPDA_FluxSimulationState_C::SetSimulationWorld(const struct FVector& Location, const struct FVector& Size, int32 Frame, const struct FIntPoint& Resolution_0, const struct BS_FluxRectBlend_0::FBS_FluxRectBlend& Blend, double DepthOffset, double DeltaTime, int32 IterationsPerSecond_0)
{
	static class UFunction* Func = nullptr;
